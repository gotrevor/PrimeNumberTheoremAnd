...
@[blueprint
  ...
  (statement := /-- One has $-0.8 \leq \frac{t - \psi(t)}{\sqrt{t}} \leq 0.81$ for $100 \leq t \leq 5 \times 10^{10}$.  See \cite[Eq. (6.2)]{Buthe}; verified by Büthe via the Eratosthenes sieve. -/)
  (latexEnv := "lemma")]
